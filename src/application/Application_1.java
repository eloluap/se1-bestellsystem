...
//		Customer cTimo = new Customer( "C24792", "Timo Werner", "tw@gmail.com" );
//		Customer cSandra = new Customer( "C87432", "Sandra Müller", "samue62@gmx.de" );
//
...
//		Article aKaffeemaschine = new Article( "SKU-782364", "Kaffeemaschine", 2999, 500 );
//		Article aTeekocher = new Article( "SKU-927333", "Teekocher", 1999, 2000 );
//
//		// Eric's 1st order
...
//		
//		// Timo's order
//		Order o4835 = new Order( 4835735356L, new Date(), cTimo );
//		o4835.addItem(
...
//		
//		//Sandra's order
//		Order o6399 = new Order( 6399437335L, new Date(), cSandra );
//		o6399.addItem(
...
//
//		/*
//		 * Insert other customers, articles and orders.
//		 */
//
//		application.printOrders( orders );		// Ausgabe aller Bestellungen
	...
	private void printOrders( List<Order> orders ) {
		...
		for (Order o: orders) {
			...
			text += o.getId();
			text += ", ";
			text += o.getCustomer().getFirstName();
			text += "'s Bestellung: ";
